...
class Smt2Term : public AbsTerm
{
 ...
 private:
  ...
  std::unordered_map<std::string, std::string> d_op_kind_to_str = {
      ...
      {Op::BV_NOT, "bvnot"},
      {Op::BV_OR, "bvor"},
      //{Op::BV_REDAND, "unsupported"},
      //{Op::BV_REDOR, "unsupported"},
      //{Op::BV_SADDO, "unsupported"},
      {Op::BV_SDIV, "bvsdiv"},
      //{Op::BV_SDIVO, "unsupported"},
      {Op::BV_SGE, "bvsge"},
      {Op::BV_SGT, "bvsgt"},
      {Op::BV_SHL, "bvshl"},
      {Op::BV_SLE, "bvsle"},
      {Op::BV_SLT, "bvslt"},
      {Op::BV_SMOD, "bvsmod"},
      //{Op::BV_SMULO, "unsupported"},
      {Op::BV_SREM, "bvsrem"},
      //{Op::BV_SSUBO, "unsupported"},
      {Op::BV_SUB, "bvsub"},
      //{Op::BV_UADDO, "unsupported"},
      {Op::BV_UDIV, "bvudiv"},
      {Op::BV_UGE, "bvuge"},
      {Op::BV_UGT, "bvugt"},
      {Op::BV_ULE, "bvule"},
      {Op::BV_ULT, "bvult"},
      //{Op::BV_UMULO, "unsupported"},
      {Op::BV_UREM, "bvurem"},
      //{Op::BV_USUBO, "unsupported},
      {Op::BV_XNOR, "bvxnor"},
      {Op::BV_XOR, "bvxor"},
      //{Op::BV_INC, "unsupported"},
      //{Op::BV_DEC, "unsupported"},
      //{Op::BV_REDXOR, "unsupported"},
